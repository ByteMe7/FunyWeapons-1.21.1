...
public class TurquoiseObsidianTearFallingParticle extends SpriteBillboardParticle {
    protected TurquoiseObsidianTearFallingParticle(ClientWorld level, double xCoord, double yCoord, double zCoord,
    ...
    public static class Factory implements ParticleFactory<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType particleType, ClientWorld level, double x, double y, double z,
            ...
            SpriteBillboardParticle fallingParticle = (SpriteBillboardParticle) ModBlockLeakParticle.createFallingBlockTear(ModParticles.TURQUOISE_OBSIDIAN_TEAR_LAND, level, x, y, z, dx, dy, dz);
            fallingParticle.setSprite(this.sprites);
            var color = Colors.TURQUOISE_OBSIDIAN_TEARS;
            fallingParticle.setColor(color.getRedPercent(), color.getGreenPercent(), color.getGreenPercent());
